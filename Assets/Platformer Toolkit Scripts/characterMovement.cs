...
public class characterMovement : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        desiredVelocity = new Vector2(directionX, 0f) * Mathf.Max( gmtkSettingsSO.maxSpeed - gmtkSettingsSO.friction, 0f);
    ...
    private void FixedUpdate()
    {
        ...
        if ( gmtkSettingsSO.useAcceleration )
        {
            runWithAcceleration();
        }
        else
    ...
    private void runWithAcceleration()
    {
        ...
        acceleration = onGround ? gmtkSettingsSO.maxAcceleration : gmtkSettingsSO.maxAirAcceleration;
        deceleration = onGround ? gmtkSettingsSO.maxDecceleration : gmtkSettingsSO.maxAirDeceleration;
        turnSpeed = onGround ? gmtkSettingsSO.maxTurnSpeed : gmtkSettingsSO.maxAirTurnSpeed;
